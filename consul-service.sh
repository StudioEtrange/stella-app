...
# ./consul-service.sh create server 1 -m
# ./consul-service.sh create client 2 -m --joinid=1
# ./consul-service.sh list members 1
...
function usage() {
  ...
  echo "----------------"
  echo "o-- command :"
  echo "L     create <server> <id> [--version=<version>] [--http=<port>] [--dns=<port>] [--ip=<ip>|--if=<interface>] [--datacenter=<string>] [--domainname=<string>] [-- additional docker run options] : create & launch service (must be use once before starting/stopping service)"
  echo "L     create <client> <id> [--version=<version>] [--joinip=<ip>|joinid=<id>]  [--http=<port>] [--dns=<port>] [--ip=<ip>|--if=<interface>] [--datacenter=<string>] [--domainname=<string>] [-- additional docker run options] : create & launch service (must be use once before starting/stopping service)"
  ...
  echo "L     list members [<id>] : will list consul cluster members, by connecting to an agent <id> (1 by default)"
  echo "o-- options :"
...
# COMMAND LINE -----------------------------------------------------------------------------------
PARAMETERS="
ACTION=											'' 			a				'create start stop status shell destroy list' '1'
TARGET=											'' 			a				'client server members' '1'
ID=											'' 			s				'' '0'
"
OPTIONS="
